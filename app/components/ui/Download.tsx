...
const Download = () => {
  return (
    <div className="flex flex-col gap-1 mb-3">
        <span className="text-blue-500 font-semibold text-sm">Download Now!</span>
        <span className="text-gray-400 font-semibold text-xs my-2">Download the Lernit app for IOS &amp; Android.</span>
        <div className="flex items-center justify-center gap-2.5 mt-2.5">
          <a href="#" className="flex items-center justify-between rounded-lg p-1.5 text-decoration-none shadow-lg bg-blue-500">
